...
st.title("Chat with Bing")
st.sidebar.header("About this chatbot")
st.sidebar.markdown("This is a simple chatbot page using streamlit. You can type your message in the text box below and press enter to send it. The chatbot will reply with a message and some suggestions for the next user turn.")